...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [icGoogleLogin];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/AttendancePage.png
  AssetGenImage get attendancePage =>
      const AssetGenImage('assets/images/AttendancePage.png');
  ...
  /// File path: assets/images/Nutrition.png
  AssetGenImage get nutrition =>
      const AssetGenImage('assets/images/Nutrition.png');

  /// File path: assets/images/first_news.png
  AssetGenImage get firstNews =>
      const AssetGenImage('assets/images/first_news.png');

  /// File path: assets/images/nutrition_first.png
  AssetGenImage get nutritionFirst =>
      const AssetGenImage('assets/images/nutrition_first.png');

  /// File path: assets/images/nutrition_page.png
  AssetGenImage get nutritionPage =>
      const AssetGenImage('assets/images/nutrition_page.png');
